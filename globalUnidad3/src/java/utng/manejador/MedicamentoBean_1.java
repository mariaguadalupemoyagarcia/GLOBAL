...
public class MedicamentoBean_1 implements Serializable {
    
    private List<Medicamento> medicamentos;
    private Medicamento medicamento;
    
    
    public MedicamentoBean_1(){
    medicamento=new Medicamento();
    
    }

    public MedicamentoBean_1(List<Medicamento> medicamentos, Medicamento medicamento) {
